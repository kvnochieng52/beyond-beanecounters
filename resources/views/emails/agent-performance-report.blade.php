<div style="font-family: Arial, sans-serif; color: #333;">
    <div style="background-color: #f8f9fa; padding: 20px;">
        <div
            ...
            <p style="color: #666; line-height: 1.6; font-size: 14px;">
                Please find attached the <strong>Agent Performance Report</strong> for
                <strong>{{ $generatedAt->format('d M Y') }}</strong> at
                <strong>{{ $generatedAt->format('g:i A') }}</strong>.
            </p>
            ...
            <div
                ...
                <ul style="color: #666; margin: 0; padding-left: 20px; font-size: 13px;">
                    <li>Calls Made - Total call dispositions by agent</li>
                    <li>PTP Count & Value - Promise to Pay registrations and amounts</li>
                    <li>Collections - Daily transaction and MTD (Money Transfer Data) totals</li>
            ...
            <div
                ...
                <p style="color: #856404; margin: 0; font-size: 13px;">
                    <strong>⏰ Report Schedule:</strong> This automated report is sent every 2 hours from 8:20 AM until
                    7:00 PM daily.
                </p>
            </div>
