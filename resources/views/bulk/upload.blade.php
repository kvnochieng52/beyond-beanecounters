...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Upload Bulk Leads</h3>
    </div>
    <div class="card-body">
        <p>Download the sample CSV file for <a href="/sample_csvs/sample_individual.csv" target="_blank"><strong><i
                        class="fas fa-fw fa-user"></i> Individual</strong></a> or
            <a href="/sample_csvs/sample_entity.csv" target="_blank"><strong><i class="fas fa-fw fa-building"></i>
                    Entity</strong></a>
        </p>
