    ...
    <div class="row">
        <div class="col-md-4">
            <div class="form-group">
                {!! Html::label('Defaulter Names', 'names') !!}
                {!! Html::text('names')->class('form-control')
        ...
        <div class="col-md-4">
            <div class="form-group">
                {!! Html::label('ID/Passport Number', 'passport_number') !!}
                {!! Html::text('passport_number')->class('form-control')
                ->placeholder('')
