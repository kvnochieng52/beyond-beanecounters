...
<div class="row">
    <div class="col-md-6">
        <table class="table table-bordered table-striped">
            <tr>
                <th style="width: 40%">Full Names</th>
            ...
            <tr>
                <th>ID Number</th>
                <td>{{$leadDetails->id_passport_number}}</td>
            </tr>
            ...
            <tr>
                <th>Occupation</th>
                <td>{{$leadDetails->occupation}}</td>
            </tr>
            <tr>
                <th>Company</th>
                <td>{{$leadDetails->company_name}}</td>
            </tr>

            <tr>
                <th>Next of Kin Name</th>
                <td>{{$leadDetails->kin_full_names}} ({{$leadDetails->kin_relationship}})</td>
            </tr>
            <tr>
                <th>Next of Kin Contacts</th>
                <td>{{$leadDetails->kin_telephone}} / {{$leadDetails->kin_email}}</td>
            </tr>
        </table>
    </div>
    <div class="col-md-6">
