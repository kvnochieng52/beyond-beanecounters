...
@section('title', 'Agent Leads Report')

@section('content_header')
    <h1>Agent Leads Report</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Generate Agent Leads Report</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('reports.agent-leads.generate') }}" method="POST">
                @csrf
