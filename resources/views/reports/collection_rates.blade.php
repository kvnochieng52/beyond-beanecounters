...
@section('title', 'Collection Rates Report')

@section('content_header')
    <h1>Collection Rates Report</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Generate Collection Rates Report</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('reports.collection-rates.generate') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
