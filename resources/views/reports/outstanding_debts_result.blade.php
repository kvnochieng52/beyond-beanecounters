...
<div class="float-right">
    ...
    <a href="{{ route('reports.outstanding-debts.generate', array_merge(request()->all(), ['export' => 'excel'])) }}"
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped" id="leads-table">
                ...
                <tbody>
                    ...
                    <tr
                        class="{{ $lead['days_overdue'] > 90 ? 'table-danger' : ($lead['days_overdue'] > 60 ? 'table-warning' : ($lead['days_overdue'] > 30 ? 'table-info' : '')) }}">
                        <td>{{ $lead['id'] }}</td>
                        <td>{{ $lead['title'] }}</td>
                        ...
                        <td>
                            <span
                                class="badge bg-{{ $lead['days_overdue'] > 90 ? 'danger' : ($lead['days_overdue'] > 60 ? 'warning' : ($lead['days_overdue'] > 30 ? 'info' : 'success')) }}">
                                {{ $lead['days_overdue'] }}
                            </span>
                        </td>
