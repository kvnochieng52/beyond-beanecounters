...
@section('title', 'Collection Progress Report')

@section('content_header')
    <h1>Collection Progress Report</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Generate Collection Progress Report</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('reports.collection-progress.generate') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
