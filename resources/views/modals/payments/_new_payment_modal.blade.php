<div class="modal fade" id="new_payment_modal" tabindex="-1" aria-labelledby="newPaymentModalLabel" aria-hidden="true"
        ...
        <form action="{{ route('store-payment') }}" method="POST" class="user_form">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="newPaymentModalLabel" class="card-title">New Payment</h5>
