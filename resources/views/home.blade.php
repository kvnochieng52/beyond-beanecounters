                        ...
                        <div class="col-md-4">
                            <div class="info-box mb-3 bg-default">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <h5 class="info-box-number text-success"><a href="/leads/my-leads"
                    ...
                    <div class="row">
                        <div class="col-sm-2 col-6">
                            <div class="description-block border-right">
                                <h5 class="text-info"><a href="{{ url('leads/status/1') }}">{{ $leadStats['pending'] }}</a>
                                </h5>
                        ...
                        <div class="col-sm-2 col-6">
                            <div class="description-block border-right">
                                <h5 class="text-info"><a href="{{ url('leads/status/2') }}">{{ $leadStats['paid'] }}</a>
                                </h5>
                        ...
                        <div class="col-sm-2 col-6">
                            <div class="description-block border-right">
                                <h5 class="text-info"><a
                                        href="{{ url('leads/status/3') }}">{{ $leadStats['partially_paid'] }}</a>
                                </h5>
                        ...
                        <div class="col-sm-2 col-6">
                            <div class="description-block border-right">
                                <h5 class="text-info"><a href="{{ url('leads/status/4') }}">{{ $leadStats['overdue'] }}</a>
                                </h5>
                        ...
                        <div class="col-sm-2 col-6">
                            <div class="description-block border-right">
                                <h5 class="text-info"><a
                                        href="{{ url('leads/status/5') }}">{{ $leadStats['legal_escalation'] }}</a>
                                </h5>
                        ...
                        <div class="col-sm-2 col-6">
                            <div class="description-block">
                                <h5 class="text-info"><a
                                        href="{{ url('leads/status/6') }}">{{ $leadStats['disputed'] }}</a></h5>
                ...
                <div class="card-body p-0">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link text-dark">
                                Delivered SMS <span
                                    class="float-right badge bg-success">{{ $smsStats['delivered'] }}</span>
                            </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="ptpTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="ptp-today-tab" data-bs-toggle="tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="activities-today-tab" data-bs-toggle="tab"
                                data-bs-target="#activities-today" type="button" role="tab"
                                aria-controls="activities-today" aria-selected="false">
                                Activities Today
                                @if ($activitiesToday->count() > 0)
                                    <span class="badge text-white ms-1"
                                        style="background-color: #dc3545;">{{ $activitiesToday->count() }}</span>
                                @else
                    ...
                    <div class="tab-content mt-3" id="ptpTabContent">
                                        ...
                                        <tbody>
                                            @foreach ($ptpsToday as $ptp)
                                                <tr>
                                                    ...
                                                    <td>{{ \Carbon\Carbon::parse($ptp->act_ptp_date)->format('M d, Y') }}
                                                    </td>
                                                    <td>
                                                        <a href="/lead/{{ $ptp->lead_id }}"
                        ...
                        <!-- Today's Activities -->
                        <div class="tab-pane fade" id="activities-today" role="tabpanel"
                            aria-labelledby="activities-today-tab">
                            @if ($activitiesToday->count() > 0)
                                <div class="table-responsive">
                                    <table class="table table-striped table-sm">
                                        <thead>
                        ...
                        <tbody>
                            ...
                            @foreach ($recentLeads as $lead)
                                <tr>
                                    ...
                                    <td><strong>{{ $lead->currency_name }}
                                            {{ number_format($lead->amount, 0, '.', ',') }}</strong></td>
                                    <td>
                                        <a href="/lead/{{ $lead->id }}">
